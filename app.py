...
def main():
    load_dotenv()
    st.set_page_config(page_title="Chat on documents",page_icon=':books')
    ...
    st.header("Chat with your Documents PDF :books:")
    ...
    with st.sidebar:
        ...
        pdf_doc=st.file_uploader("Upload your PDFs here and click on process",accept_multiple_files=True)
